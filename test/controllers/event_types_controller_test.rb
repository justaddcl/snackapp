...
class EventTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create event_type" do
    assert_difference('EventType.count') do
      post event_types_url, params: { event_type: { event_type_description: @event_type.event_type_description } }
    end
  ...
  test "should update event_type" do
    patch event_type_url(@event_type), params: { event_type: { event_type_description: @event_type.event_type_description } }
