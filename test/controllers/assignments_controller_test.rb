...
class AssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assignment" do
    assert_difference('Assignment.count') do
      post assignments_url, params: { assignment: { event: @assignment.event, user: @assignment.user } }
    end
  ...
  test "should update assignment" do
    patch assignment_url(@assignment), params: { assignment: { event: @assignment.event, user: @assignment.user } }
